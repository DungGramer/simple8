let index = 0;
	...
	function change2main(event) {
		path = event.path[1].querySelector('li img').getAttribute('src');
		// document.querySelector('.product__image-main').setAttribute('src', path); Using for img
		document.querySelector('.product__image-main').style.backgroundImage = "url('"+path+"')";
	}
		...
		img.onload = function () {
			...
			container.onmousemove = function (e) {
				...
				Object.assign(container.style, {
					...
					backgroundSize: imgHeight / 1.2 + 'px'
				});
			};
